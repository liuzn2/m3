...
For more advanced setups, it's best to follow the guides on how to configure an M3DB cluster [manually](/docs/getting_started/binaries_cluster) or [using Kubernetes](/docs/getting_started/kubernetes_cluster). However, this tutorial will walk you through configuring a single node setup locally for development.
